 ...
 * @param {string} [filtros.estado]       - BORRADOR | VALIDADA | CERTIFICADA | ANULADA
 * @param {string} [filtros.fecha_desde]  - YYYY-MM-DD
 * @param {string} [filtros.fecha_hasta]  - YYYY-MM-DD
 * @param {number} [filtros.limit]        - Default 50
 ...
 * @param {Object} filtros
 * @param {number} [filtros.cliente_id]
 * @param {string} [filtros.estado_cobro] - PENDIENTE | PAGADA | VENCIDA | ANULADA
