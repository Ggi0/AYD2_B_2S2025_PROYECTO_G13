 ...
 *
 * @route POST /api/facturacion/borrador/:orden_id
 ...
 *
 * @route POST /api/facturacion/:factura_id/validar
 ...
 *
 * @route GET /api/facturacion/cobros
 * @auth AGENTE_FINANCIERO | AREA_CONTABLE
 * @query {
 *   cliente_id:   number (opcional)
 ...
 *
 * @route GET /api/facturacion/orden/:orden_id
 * @auth AGENTE_FINANCIERO | AREA_CONTABLE
 */
